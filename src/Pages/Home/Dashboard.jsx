...
const StatCard = ({ title, value, subtitle, icon, bg }) => (
  <div className="bg-white rounded-xl p-4 shadow-sm">
    <div className="flex items-start justify-between">
      ...
      <div
        className={`w-10 h-10 rounded-md flex items-center justify-center text-white ${bg}`}
      >
        {icon}
      </div>
    </div>
...
const Dashboard = () => {
  const pending = useSelector((state) => state.institute.counts.pending) || 0;
  const verified = useSelector((state) => state.institute.counts.verified) || 0;
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <StatCard
          ...
          value="248"
          subtitle="186 verified, 62 pending"
          icon={
        ...
        <StatCard
          ...
          icon={
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
              <path
                d="M12 2l9 4.5v6c0 5-9 9.5-9 9.5S3 17.5 3 12v-6L12 2z"
                fill="white"
              />
            </svg>
          }
        ...
        <StatCard
          ...
          icon={
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
              <path
                d="M12 2l3 7h7l-5.5 4.5L19 22l-7-4-7 4 1.5-8.5L2 9h7l3-7z"
                fill="white"
              />
            </svg>
          }
        ...
        <StatCard
          ...
          value={pendingCount}
          subtitle="Institutes awaiting approval"
          icon={
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
              <path d="M12 2a10 10 0 100 20 10 10 0 000-20z" fill="white" />
            </svg>
          }
          bg="bg-orange-400"
        />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-3">
            <div className="bg-indigo-50 text-indigo-700 px-4 py-3 rounded">
              Review Pending Institutes
              <br />
              <span className="text-sm text-indigo-500">
                8 institutes waiting
              </span>
            </div>
            <div className="bg-amber-50 text-amber-700 px-4 py-3 rounded">
              Verify Teachers
              <br />
              <span className="text-sm text-amber-500">
                62 pending verification
              </span>
            </div>
            <div className="bg-emerald-50 text-emerald-700 px-4 py-3 rounded">
