...
const initialInstitutes = [
  {
    ...
    expectedStudents: '350 students',
    description: 'Premier research university with focus on engineering and sciences',
  },
  {
    id: 2,
    ...
    contactPerson: 'Prof. Amanda Stevens',
    registeredDate: '2024-10-18',
    expectedStudents: '280 students',
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-800 mt-0.5">{institute.address}</div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-800 mt-0.5">{institute.contactPerson}</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-800 mt-0.5">{institute.expectedStudents}</div>
                  </div>
                </div>
              </div>
            </div>
